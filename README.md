...
**AI & Automation:** Python · FastAPI · n8n · LLM APIs · AI Agents · Pydantic

**Security:** Burp Suite · OWASP ZAP · Bandit · pip-audit · sqlmap · Postman · curl · OWASP LLM Top 10 · Prompt Injection awareness

**Infra & Data:** PostgreSQL (Supabase) · SQLite · Railway · GitHub Actions · Docker basics

---

### 🎯 What I focus on

1. **Secure AI workflows** — input validation, prompt injection blocking, output validation, safe fallbacks
2. **Production-ready automation** — rate limiting, authentication, logging, monitoring, error handling
3. **Honest builds** — I document what works, what failed, and what I'd do differently
